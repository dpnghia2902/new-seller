  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      if (errorCode === 'NOT_VERIFIED') {
        setError('⚠️ Your seller account is pending verification. Please wait for admin approval before adding products.');
      } else if (errorCode === 'NO_SHOP') {
      ...
      <div className="products-page">
        ...
        {!isVerified && (
          <div className="warning-banner">
            ⚠️ Your seller account is pending verification. You cannot add or edit products until an admin approves your account.
            <button 
              onClick={async () => {
                setLoading(true);
                await refreshUser();
